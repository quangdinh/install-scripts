...
sudo pacman -S --noconfirm gnome-shell gnome-backgrounds gdm xdg-utils xdg-user-dirs-gtk alacritty gnome-control-center gnome-keyring mutter gnome-menus gnome-themes-extra wl-clipboard lipappindicator-gtk3 xdg-desktop-portal-gnome xdg-desktop-portal
