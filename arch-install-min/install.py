...
if gnome:
  ...
  if gnome_utils:
    ...
    run_chroot("/usr/bin/pacman", "-S --noconfirm", "eog evince file-roller kitty gnome-screenshot gnome-shell-extensions gnome-system-monitor nautilus sushi gnome-tweaks noto-fonts noto-fonts-emoji gnome-calculator gvfs gvfs-smb gvfs-nfs gvfs-mtp gvfs-afc")
    print("Done")
  if gnome_multimedia:
